...
class AdraApiTcp : public AdraApiBase {
 public:
   ...
   * @param   int     baud      Set the baud rate of the EtherNet to RS485/CAN module to be the same as that of the
   * actuator. If the baud rate is set to 0xFFFFFFFF, the baud rate of the EtherNet to RS485/CAN module is not set. The
